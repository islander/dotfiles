...
if &term =~ '256color'
  ...
  if exists('$TMUX')
    "let &t_SI = '\<Esc>[3 q'
    "let &t_EI = '\<Esc>[0 q'
    " source: http://blog.terriblelabs.com/blog/2013/02/09/stupid-vim-tricks-how-to-change-insert-mode-cursor-shape-with-tmux/
    " source: https://github.com/jszakmeister/vim-togglecursor/blob/master/plugin/togglecursor.vim
